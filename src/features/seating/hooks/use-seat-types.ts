...
import { getAll, createSeatingType, updateSeatingType, deactivateSeatType } from '../services/seat-type.service';
...
export const useSeatTypes = () => {
    ...
    const createSeatType = async (data: any) => {
        try {
    ...
    const updateSeatType = async (data: any, id: number) => {
        try {
